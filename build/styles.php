 ...
 *
 * Note: These styles can be overridden by calling wp_frappe_data_store_override_style()
 ...
 */
function wp_frappe_data_store_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
 ...
 * @param WP_Styles $styles WP_Styles instance.
 */
function wp_frappe_data_store_register_package_styles( $styles ) {
	...
	foreach ( $styles_data as $style_data ) {
		wp_frappe_data_store_override_style(
			$styles,
			$style_data['handle'],
...
add_action( 'wp_default_styles', 'wp_frappe_data_store_register_package_styles' );
