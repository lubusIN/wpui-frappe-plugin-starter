 ...
 *                                    Default 'false'.
 */
function wp_frappe_data_store_override_script( $scripts, $handle, $src, $deps = array(), $ver = false, $in_footer = false ) {
 ...
 */
function wp_frappe_data_store_register_package_scripts( $scripts ) {
	...
	foreach ( $scripts_data as $script_data ) {
		...
		wp_frappe_data_store_override_script(
			$scripts,
			$script_data['handle'],
...
add_action( 'wp_default_scripts', 'wp_frappe_data_store_register_package_scripts' );
